...
To be clear, Python is the language we will use, and we will use Thonny to write it.  Like using Microsoft ord to write English, we will be using Thonny to write Python.
...
- Let's unpack that error message:
  ...
  - Parentheses are the curved bracket we removed.
